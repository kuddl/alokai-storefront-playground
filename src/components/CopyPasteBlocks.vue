<template>
  <div class="flex flex-col justify-center items-center gap-4 border-y p-4">
    <p class="typography-headline-3">Copy/Paste pre-built Blocks</p>
    <div
      class="
        flex
      ...
      <div class="flex flex-col pl-4 min-w-[180px] flex-1">
        ...
        <div class="items-center sm:mt-auto sm:flex">
          <span
            class="
              font-bold
              sm:ml-auto sm:order-1
              typography-text-sm
              sm:typography-text-lg
            "
            >$2,345.99
          </span>
